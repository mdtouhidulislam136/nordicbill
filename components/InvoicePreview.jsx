    ...
    <div className="invoice-preview-container formal">
      ...
      <div className="bank-transfer-slip">
        ...
        <div className="slip-row border-bottom">
          ...
          <div className="slip-cell" style={{ width: '150px', display: 'flex', flexDirection: 'column', padding: '4px' }}>
        ...
        <div className="slip-row">
          ...
          <div className="slip-cell" style={{ width: '150px' }}></div>
        </div>
        ...
        <div className="slip-row border-top">
          ...
          <div className="slip-cell" style={{ width: '250px', display: 'flex', flexDirection: 'column' }}>
